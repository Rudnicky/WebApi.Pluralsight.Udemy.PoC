...
namespace WebApi.Pluralsight.Udemy.PoC.DbContexts
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>().HasData(
                    new Author()
                    {
                        ...
                        DateOfBirth = new DateTime(1991, 7, 23),
                        MainCategory = "Ships"
                    },
                    new Author()
                    {
                        ...
                        DateOfBirth = new DateTime(1989, 5, 21),
                        MainCategory = "Rum"
                    },
                    new Author()
                    {
                        ...
                        DateOfBirth = new DateTime(1999, 12, 16),
                    ...
                    new Author()
                    {
                        ...
                        DateOfBirth = new DateTime(1976, 4, 5),
                    ...
                    new Author()
                    {
                        ...
                        DateOfBirth = new DateTime(1951, 10, 11),
                        MainCategory = "Rum"
                    }
                );
