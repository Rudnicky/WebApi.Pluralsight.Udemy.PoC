...
namespace WebApi.Pluralsight.Udemy.PoC.Migrations
{
    ...
    [Migration("20200223130043_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Pluralsight.Udemy.PoC.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1991, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Berry",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1989, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Nancy",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1999, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Eli",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(2000, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Arnold",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(2005, 11, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Seabury",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1976, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1951, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Atherton",
            ...
            modelBuilder.Entity("WebApi.Pluralsight.Udemy.PoC.Entities.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApi.Pluralsight.Udemy.PoC.Entities.Book", b =>
                {
                    b.HasOne("WebApi.Pluralsight.Udemy.PoC.Entities.Author", "Author")
                        .WithMany("Books")
